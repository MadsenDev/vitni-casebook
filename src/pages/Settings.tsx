  ...
  return (
    <div>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 24 }}>
        {[{ title: 'Operation Glass Harbor', id: caseData.caseId, updated: '2 hours ago', active: true }, { title: 'Case: Source Registry', id: 'C-2025-0098', updated: '3 days ago', active: false }, { title: 'Tip verification — anon', id: 'C-2025-0103', updated: '1 week ago', active: false }].map(c => (
